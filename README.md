...
`docs/turn-12-brief.md`, `docs/turn-13-brief.md`, `docs/turn-14-brief.md` and `docs/turn-15-brief.md`. The build reports
are `REPORT-T1.md` to `REPORT-T16.md`.

The sprite contract between the art side and the game is `docs/art/SPRITES.md`; the art Turn 13
asks for is listed in `docs/art/REQUESTS-T13.md` and the art Turn 14 asks for in
`docs/art/REQUESTS-T14.md`.
