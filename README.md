...
`docs/turn-16-brief.md`, `docs/turn-17-brief.md`, `docs/turn-18-brief.md` and
`docs/turn-19-brief.md`. The build reports are `REPORT-T1.md` to `REPORT-T20.md`.
...
`docs/art/REQUESTS-T17.md`, Turn 19's in `docs/art/REQUESTS-T19.md` and Turn 20's in
