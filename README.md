...
`docs/turn-16-brief.md`, `docs/turn-17-brief.md` and `docs/turn-18-brief.md`. The build reports are
`REPORT-T1.md` to `REPORT-T19.md`.
...
`docs/art/REQUESTS-T17.md` and Turn 19's in `docs/art/REQUESTS-T19.md`.
