...
`docs/turn-8-brief.md`, `docs/turn-9-brief.md`, `docs/turn-10-brief.md`, `docs/turn-11-brief.md` and
`docs/turn-12-brief.md`. The build reports are `REPORT-T1.md` to `REPORT-T13.md`.

The sprite contract between the art side and the game is `docs/art/SPRITES.md`; the art Turn 13
asks for is listed in `docs/art/REQUESTS-T13.md`.
