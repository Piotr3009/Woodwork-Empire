 ...
 *  without running the workshop for six months to get there (v51). */
...
describe('the service, every six months on the calendar (PIOTR, 22.09; v51)', () => {
  it('falls due six months after the purchase or the last service, whatever hours it has run', () => {
    // Until v51 it fell due after 80 hours of the machine's own clock, so a saw with three men on
